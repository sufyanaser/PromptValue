      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <input
          ...
          className={cn(
            ...
            "bg-surface2-light dark:bg-surface2-dark border-border/40 focus:border-accent group-focus-within:border-accent",
            error && "border-danger",
            className
          )}
          {...props}
      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <textarea
          ...
          className={cn(
            ...
            "bg-surface2-light dark:bg-surface2-dark border-border/40 focus:border-accent",
            error && "border-danger",
            className
          )}
          {...props}
